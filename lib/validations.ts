...
export const inquiryFormSchema = z.object({
  ...
  email: emailSchema,
  telefon: z.string().regex(/^[+]?[\d\s\-().]{7,15}$/, "Unesite ispravan broj telefona"),
  poruka: z.string().max(2000).optional(),
});

export type InquiryFormValidated = z.infer<typeof inquiryFormSchema>;
